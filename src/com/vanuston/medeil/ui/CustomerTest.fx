...
public class CustomerInformation {
    ...
    public function save(chk: Integer): Integer {
        ...
        try {
            ...
            var msg: String = "Class : Customer Information  Method : Save()   = {e.getMessage()}";
            log.debug(msg);
        }
        return cust;
    }
...
//                FXinfo("Only Alphabets can be entered for Family Name."); txtCustFName.requestFocus();
            ...
            var msg: String = "Class : Customer Information  Method : ClickValid()   = {e.getMessage()}";
            log.debug(msg);
        }
        return cnt;
    }
